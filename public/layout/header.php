...
<!--                        <li><a class="dropdown-item" href="../public/loginMedewerker.php">Log in Medewerker</a></li>-->
                    </ul>
                </li>
            <ul class="navbar-nav mr-auto">

<!--                <li class="nav-item active">-->
<!--                    <a class="nav-link" href="../public/login.php">Log in gebruiker</a>-->
<!--                </li>-->
<!--                <li class="nav-item active">-->
<!--                    <a class="nav-link" href="../public/registreren.php">Registreer in gebruiker</a>-->
<!--                </li>-->
                <li class="nav-item">
            ...
            ?>
                ...
                if($_SESSION['role'] == 1 ){
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="../admin/medewerkerWijz.php">Medewerker Beheer</a>
                        </li>
                    </ul>
                    <?php
                } else{
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../klant/klantAccount.php">Account</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="cart.php">Winkelwagen</a>
                        </li>
