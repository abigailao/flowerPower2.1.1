...
?>
    ...
    <div class="row">
        ...
        <a href="orderDetails.php"><button style="background-color: #c45832;" type="button" class="btn btn-primary mt-2 border-0">Ga verder</button></a>
        <a href="bouquets.php"><button style="background-color: #c45832;" type="button" class="btn btn-primary mt-2 border-0">Verder winkelen</button></a>
        <script type="text/javascript" src="../admin/uploadTemp/customWerkEdit.js"></script>
        <?php
        } else {
            ?>
